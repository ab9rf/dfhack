...
const struct_identity boulder_percent_options::_identity{ typeid(boulder_percent_options), sizeof(boulder_percent_options), &df::allocator_fn<boulder_percent_options>, NULL, "boulder_percents", NULL, boulder_percent_options_fields };
...
const struct_identity dig_now_options::_identity{ typeid(dig_now_options), sizeof(dig_now_options), &df::allocator_fn<dig_now_options>, NULL, "dig_now_options", NULL, dig_now_options_fields };
