...
struct_identity blueprint_options::_identity(sizeof(blueprint_options), typeid(blueprint_options), & df::allocator_fn<blueprint_options>, NULL, "blueprint_options", NULL, blueprint_options_fields);
