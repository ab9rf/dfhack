...
struct blueprint_options {
    ...
    static struct_identity<blueprint_options> _identity;
};
...
struct_identity<blueprint_options> blueprint_options::_identity(NULL, "blueprint_options", NULL, blueprint_options_fields);
