...
struct prospect_options {
    ...
    static struct_identity<prospect_options> _identity;
};
...
struct_identity<prospect_options> prospect_options::_identity(NULL, "prospect_options", NULL, prospect_options_fields);
