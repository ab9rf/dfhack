...
struct CheckedStructure
{
    ...
    const enum_identity_base *eid;
    bool ptr_is_array;
    bool inside_structure;

    CheckedStructure();
    explicit CheckedStructure(const type_identity *, size_t = 0);
    CheckedStructure(const type_identity *, size_t, const enum_identity_base *, bool);
...
#endif
    static const char *const *get_enum_item_key(const enum_identity_base *identity, int64_t value);
    static const char *const *get_enum_item_attr_or_key(const enum_identity_base *identity, int64_t value, const char *attr_name);
...
private:
    ...
    void dispatch_field(const QueueItem &, const CheckedStructure &, const struct_identity_base *, const struct_field_info *);
    ...
    void check_stl_map(const QueueItem &, const container_identity_base *);
    void check_stl_unordered_map(const QueueItem &, const container_identity_base *);
