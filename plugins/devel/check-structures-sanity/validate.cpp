...
const char *const *Checker::get_enum_item_key(const enum_identity_base *identity, int64_t value)
{
    return get_enum_item_attr_or_key(identity, value, nullptr);
}

const char *const *Checker::get_enum_item_attr_or_key(const enum_identity_base *identity, int64_t value, const char *attr_name)
{
    size_t index;
