...
struct autobutcher_options {
    ...
    static struct_identity<autobutcher_options> _identity;
...
struct_identity<autobutcher_options> autobutcher_options::_identity(NULL, "autobutcher_options", NULL, autobutcher_options_fields);
