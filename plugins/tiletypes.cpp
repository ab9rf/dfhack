...
struct tiletypes_options {
    ...
    static struct_identity<tiletypes_options> _identity;
};
...
struct_identity<tiletypes_options> tiletypes_options::_identity(NULL, "tiletypes_options", NULL, tiletypes_options_fields);
