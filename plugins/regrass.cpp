...
const struct_identity regrass_options::_identity{ typeid(regrass_options), sizeof(regrass_options), &df::allocator_fn<regrass_options>, NULL, "regrass_options", NULL, regrass_options_fields };
