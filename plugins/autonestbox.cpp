...
struct autonestbox_options {
    ...
    static struct_identity<autonestbox_options> _identity;
};
...
struct_identity<autonestbox_options> autonestbox_options::_identity(NULL, "autonestbox_options", NULL, autonestbox_options_fields);
